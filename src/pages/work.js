...
const WorkPage = () => (
  <Layout>
    ...
    <div class="work-section">
      <h3>FedEx &#128230;</h3>
      <p>For 10 weeks in the summer of 2019, I interned with FedEx in Colorado Springs, Colorado. I was able to be involved with full stack development on two agile scrums teams. We improved and maintained several applications dealing with international clearance for shipments.</p>
    ...
    <div class="work-section">  
      <h3>BYU IS &#128187;</h3>
      <p>During the school year, I worked part time in the Independent Study office of Brigham Young University. In the Computer Operations department, I was a QA tester, providing support and maintenance to an online registration service. I manually tested Jira tickets for new features and customer issues, providing feedback to developers. I also used Selenium to write and run automated tests that check hundreds of functions weekly. </p>
    </div>
    <div class="work-section">  
      <h3>Lizard Skins &#129422;</h3>
      <p>For a year and a half, I worked at Lizard Skins, a sporting goods manufacturer based in American Fork, Utah. I worked in the warehouse, shipping products around the globe, packaging goods, and invoicing customers using Oracle NetSuite and ShipStation. One of my favorite parts of the job was using an Adobe Illustrator and an Epilog laser engraver to create custom metal lock-rings for mountain bike grips. I mean, who doesn’t love lasers?!</p>
    </div>
    <div class="work-section">  
      <h3>Missionary Service &#127809;</h3>
      <p>Over two years, I left school and work behind to serve as a volunteer missionary for the Church of Jesus Christ of Latter-day Saints in Quebec, Canada. I lived in several towns across the province, both urban and rural. I was able to serve people from a variety of backgrounds (over 70 different countries of origin), learn French, and support local church congregations. These two years taught me about the importance of learning from others and so much more.</p>
    </div>
  </Layout>
)
