...
const SchoolPage = () => (
  <Layout>
    ...
    <div class="work-section">  
      ...
      <p>I am in my last two semesters of the <a href="https://marriottschool.byu.edu/infosys/mism/what-will-i-study/program-overview/">Masters of Information Systems Management</a> program, an 2 year integrated graduate program at BYU. I will graduate in April 2021 with my bachelor's of science in Information Systems and a master's degree in Information Systems Management. </p>
      <p>Over the next semesters, I will complete a capstone project, in addition to these classes:</p>
      ...
      <p>I've enjoyed diving deeper into subjects that I've studied before, but still having a wide range of topics between different classes. School is fun when your classes are interesting!</p>
    </div>
    <div class="work-section">
